...
def first_view(request):
	...
	for state in states:
		...
		for city in cities:
			...
			state_string += "State Name: %s , City Name: %s </br>" % (state.name, city.name)
...
states = { state1:{name:'Texas', capital:'San Antonio'}, state2: {‘name':'California', ‘capital':'Sacramento'}}
